  ...
  return (
    <div className="max-w-7xl mx-auto px-4 my-[100px]">
       <div className="text-center flex flex-col items-center justify-center mb-12">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">How CRWD Work</h1>
        <p className="text-[#393939] text-xl text-center w-[80%]">
      ...
      <div className='xl:flex hidden  flex-row items-center justify-center gap-5'>
          <div className='flex flex-col justify-center items-center w-[30%]'>
            ...
            <h3 className="text-[25px] font-semibold mb-2">Choose Nonprofits</h3>
          ...
          <div className='flex flex-col justify-center items-center  w-[30%]'>
            <img src='how1.svg' className='w-45 h-45 rounded-full'/>
            <div className="text-center flex flex-col justify-center items-center ">
            <h3 className="text-[25px] font-semibold mb-2">Create a Purpose</h3>
          ...
          <div className='flex flex-col justify-center items-center  w-[30%]'>
            <img src='how1.svg' className='w-45 h-45 rounded-full'/>
            <div className="text-center flex flex-col justify-center items-center ">
            <h3 className="text-[25px] font-semibold mb-2">Celebrate and Grow</h3>
      ...
      <div className='flex   xl:hidden flex-col mx-auto w-fit  items-start justify-center '>
          ...
          <div className='flex flex-row gap-5 justify-center items-center'>
            <img src='how1.svg' className='w-34 h-34 rounded-full'/>
            <div className="flex flex-col  ">
            <h3 className="text-3xl font-semibold mb-2">Create a Purpose</h3>
          ...
          <div className='flex flex-row gap-5 justify-center items-center'>
            <img src='how1.svg' className='w-34 h-34 rounded-full'/>
            <div className="flex flex-col ">
            <h3 className="text-3xl font-semibold mb-2">Celebrate and Grow</h3>
