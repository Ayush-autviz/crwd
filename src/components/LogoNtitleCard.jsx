...
const locationIcon = <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <>
                                <div className="bg-[#F3F3F2] rounded-xl p-3 md:px-[25px] md:py-[15px] flex items-center gap-4 md:gap-11">
                                    ...
                                    <div className="">
                                        ...
                                        <p className="flex items-center gap-1 md:gap-3 mt-3 shareBtns">{locationIcon}
                                            <span className="text-[10px] md:text-lg ">{i.location}</span>
                                        </p>
                                    </div>
                                </div>
                            </>
