...
<div className="text-[40px] font-semibold  my-4">Choose Nonprofit(s)</div>
  ...
  >
    <div className="flex items-center gap-2">
      {selectedNonprofits.length === 0 ? (
        <span className="text-gray-500 p-2 ">Select nonprofits...</span>
      ) : (
...
<div className="text-[40px] font-semibold  my-4">Why are you raising money?</div>
          ...
          {/* <div className="flex gap-2 p-2 border-b bg-white">
            ...
            <button className="p-2 hover:bg-gray-100 rounded">
              ...
              <div className="border-2 border-dashed rounded-3xl p-8 flex flex-col items-center justify-center text-gray-500">
                ...
                <span className='text-[#808080]'>Add Content</span>
              </div>
